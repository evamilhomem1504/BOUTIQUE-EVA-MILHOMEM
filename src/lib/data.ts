...
export const products: Product[] = [
  ...
  },
  {
    ...
    name: "Bolsa Santa Lolla Palha",
    slug: "bolsa-santa-lolla-palha",
    description: "Bolsa Santa Lolla em palha natural trançada com detalhes em couro caramelo e ferragens douradas. Espaçosa e elegante, perfeita para os dias de sol e looks de verão.",
    price: 669.90,
    category: "bolsas",
    gender: "feminino",
    images: [
      { url: `${P}/bolsa-santa-lolla-palha-1.jpg`, alt: "Bolsa Santa Lolla palha com couro caramelo — Boutique Eva Milhomem" },
      { url: `${P}/bolsa-santa-lolla-palha-2.jpg`, alt: "Bolsa Santa Lolla palha — detalhe da etiqueta e ferragens" },
      { url: `${P}/bolsa-santa-lolla-palha-3.jpg`, alt: "Bolsa Santa Lolla palha — vista das alças" },
    ],
    sizes: ["Único"],
    colors: ["Palha"],
    inStock: true,
