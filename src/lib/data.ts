...
export const products: Product[] = [
...

  {
    ...
    description: "Maiô Bana Bana listrado preto e branco, com modelagem cavada e caimento elegante. Estampa atemporal que combina com a Saída Calça Longa Bana Bana para um look completo. Tamanho P. Disponível no crediário em até 10x.",
    price: 279.90,
    category: "maiôs",
    gender: "feminino",
    images: [
      { url: `${P}/maio-estampado-banabana.jpg`, alt: "Maiô Estampado BanaBana listrado preto e branco — Boutique Eva Milhomem" },
      { url: `${P}/conjunto-banabana-listrado.jpg`, alt: "Conjunto BanaBana — Maiô listrado e Saída Calça Longa" },
    ],
    sizes: ["P"],
    ...
    featured: true,
    isNew: true,
    tags: ["maiô", "bana bana", "listrado", "preto e branco", "estampado", "praia", "verão"],
  },
  {
    id: "f39",
    name: "Saída Calça Longa BanaBana",
    slug: "saida-calca-longa-banabana",
    description: "Saída de praia calça longa pantalona Bana Bana em tecido fluido off white com estampa de linhas pretas geométricas, cintura com elástico e cordão. Leve e sofisticada, combina com o Maiô Estampado Bana Bana. Tamanho P. Disponível no crediário em até 10x.",
    price: 299.90,
    category: "saídas-de-praia",
    gender: "feminino",
    images: [
      { url: `${P}/saida-calca-longa-banabana.jpg`, alt: "Saída Calça Longa BanaBana off white com linhas pretas — Boutique Eva Milhomem" },
      { url: `${P}/conjunto-banabana-listrado.jpg`, alt: "Conjunto BanaBana — Maiô listrado e Saída Calça Longa" },
    ],
    sizes: ["P"],
    colors: ["Off White/Preto"],
    ...
    featured: true,
    isNew: true,
    tags: ["saída de praia", "calça", "pantalona", "bana bana", "off white", "linhas", "praia", "verão"],
  },
  ...
  {
    id: "b10",
    name: "Bolsa Santa Lolla Palha",
    slug: "bolsa-santa-lolla-palha",
    description: "Bolsa Santa Lolla estruturada em palha natural com detalhes em couro caramelo e ferragens douradas. Espaçosa e elegante, perfeita para compor looks de verão com sofisticação.",
    price: 669.90,
    category: "bolsas",
    gender: "feminino",
    images: [
      { url: `${P}/bolsa-santa-lolla-palha-2.jpg`, alt: "Bolsa Santa Lolla em palha natural com couro caramelo — vista frontal" },
      { url: `${P}/bolsa-santa-lolla-palha-3.jpg`, alt: "Bolsa Santa Lolla em palha — detalhe das alças trançadas" },
      { url: `${P}/bolsa-santa-lolla-palha-1.jpg`, alt: "Bolsa Santa Lolla em palha — detalhe da etiqueta e ferragem dourada" },
    ],
    sizes: ["Único"],
    colors: ["Palha"],
    inStock: true,
    featured: true,
    isNew: true,
    tags: ["bolsa", "santa lolla", "palha", "natural", "couro", "verão"],
  },
  {
    id: "b11",
    name: "Bolsa Santa Lolla Carteira Caramelo",
    slug: "bolsa-santa-lolla-carteira-caramelo",
    description: "Bolsa Santa Lolla modelo carteira em couro caramelo com pespontos contrastantes e acabamento refinado. Aba envelope com fecho e alça removível — elegância atemporal para qualquer ocasião.",
    price: 449.90,
    category: "bolsas",
    gender: "feminino",
    images: [
      { url: `${P}/bolsa-santa-lolla-carteira-caramelo.png`, alt: "Bolsa Santa Lolla carteira caramelo — Boutique Eva Milhomem" },
    ],
    sizes: ["Único"],
    colors: ["Caramelo"],
    inStock: true,
    featured: true,
    isNew: true,
    tags: ["bolsa", "santa lolla", "carteira", "caramelo", "couro", "envelope"],
  },
  {
    id: "c5f",
